        ...
        {products.map((product, index) => {
          ...
          return (
            <div
              className={
                isCurrentSlide
                  ? "flex justify-center items-center h-[100%] opacity-100 transition-opacity duration-1000"
                ...
                <div className="p-1 h-[100%] w-[70%] border rounded shadow-[0px_0px_4px_0px_#CB80FF]">
                  <figure className="h-[80%] w-[100%] bg-red-300 overflow-hidden">
                    <img
                      src={product.image}
                      alt={product.name}
                      className="w-[auto] h-[100%] object-cover transform transition-all duration-500 scale-150 hover:scale-100"
                    />
                  </figure>
